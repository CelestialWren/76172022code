...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    CANSparkMax frontLeftMotor = new CANSparkMax(1,brushless);
  ...
  public void teleopPeriodic() {
    drivebase.driveCartesian(controller.getLeftX(), controller.getLeftY(), controller.getRightY(), gyro.getAngle());
  }
